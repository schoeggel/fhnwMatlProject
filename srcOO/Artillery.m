...
% lediglich der Dokumentation des Projektes. Gearbeitet wird mit den
% Git-Commits:
%% Commits:
...
% Parametern erweiter auf Objektorientiert
...
% gameScreen.updateElementCol() --[x,y]Array (Bsp. Wind) Zeichnen, altes
% Objekt löschen und Handler Speichern Farbe wird Mitgegeben (patchobjekt
...
% Geschiklichkeitsmodus gameScreen.drawActualPlayer -- Zeichnet den Text
% wer aktuell am Zug ist gameScreen.getPower -- Auslesen der
% Schussenergie Taktik gameScreen.getAngle -- Auslesen des Schusswinkels
% Taktik gameScreen.updatePowerBar() -- der Powerbalken wird aktualisiert
...
for iCount = 1 : 1 : param.playerQuantety
    ...
    while state.getGameRound <= param.numberRounds
        ...
        while roundEnd == 0;
            ...
            % Nächster Spieler mit mehr als 0 Lebenspunkten wird ermittrelt
        ...
        state.nextGameRound(param); %Runde eins hochzählen wenn max anzahl erreicht ende
